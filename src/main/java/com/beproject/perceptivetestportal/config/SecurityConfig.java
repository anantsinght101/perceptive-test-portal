...
public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers("/teacher-dashboard.html", "/student-dashboard.html", "/create-test.html").permitAll()
            .requestMatchers("/teacher/**").permitAll()

            // Static
            .requestMatchers("/css/**", "/js/**", "/assets/**", "/static/**", "/favicon.ico").permitAll()
            ...
            // Protected APIs
            .requestMatchers("/tests/**").hasRole("TEACHER")
